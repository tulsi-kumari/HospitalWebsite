...
const PatientLoginForm = () => {
  ...
  const handleSubmission=async(e)=>{
    ...
    const res=await fetch('http://localhost:3000/signinPatient',{
      method:"POST",
      credentials: 'include',
      headers:{
    ...
    if(data.message==="Logged in successfully"){
      console.log(data);
       ...
       window.alert("Patient logged in successfully")
    ...
    <div className="row formLoginWrapper">
      ...
      <div className="col-lg-9">
        ...
        <form>
          ...
          <h2 className='display-6 font-weight-bold'>Patient Login</h2>
          ...
          <div className="form-floating p-2">
            <input type="password" className="form-control" id="password" placeholder='Password'  onChange={handlePasswordChange} style={{ borderColor: passError ? 'red' : 'green' }} />
